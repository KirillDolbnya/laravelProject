...
Route::get('/workers/create',[\App\Http\Controllers\WorkerController::class,'create'])->middleware('IsAdmin')->name('worker.create');
...
Route::get('/edit',[ \App\Filament\Resources\UserResource\Pages\Settings::class,'getHeaderActions'])->name('posts.edit');
